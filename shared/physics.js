// Matter.js world built from the map's collision polygons. Shared by the server
// (authoritative sim) and the client (local prediction of its own body).
import Matter from 'matter-js';
import decomp from 'poly-decomp';
import { PLAYER_W, PLAYER_H, GRAVITY_SCALE } from './constants.js';
